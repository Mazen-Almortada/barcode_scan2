...
class AndroidConfiguration extends $pb.GeneratedMessage {
  ...
  factory AndroidConfiguration.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory AndroidConfiguration.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class Configuration extends $pb.GeneratedMessage {
  factory Configuration({
    ...
    if (withImage != null) result.withImage = withImage;
    return result;
  }

  Configuration._();

  factory Configuration.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Configuration.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Configuration', createEmptyInstance: create)
    ...
    ..aOB(6, _omitFieldNames ? '' : 'withImage', protoName: 'withImage')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  $core.bool get withImage => $_getBF(5);
  @$pb.TagNumber(6)
  set withImage($core.bool value) => $_setBool(5, value);
  @$pb.TagNumber(6)
  $core.bool hasWithImage() => $_has(5);
  @$pb.TagNumber(6)
  void clearWithImage() => $_clearField(6);
}
